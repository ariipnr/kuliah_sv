...
<body>
	...
	<div>
		<section class="white" id="section2"><br>
			<h2 align="center">Form Edit Barang</h2><br>
		
			<form action="edit_barang_proses.php" method="post" enctype="multipart/form-data">
				<table width="500" align="center" border="0">
					<td>
						<div class="input-group mb-3">
						   <input type="hidden" name="no" class="form-control" placeholder="no" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $data["no"]; ?>" >
						</div>
						<label for="basic-url">Kode Alat</label>
						<div class="input-group mb-3">
						   <input type="text" name="kd_alat" class="form-control" placeholder="Kode Alat" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $data["kode_alat"]; ?>" >
						</div>
						...
						<div class="input-group mb-3">
						   <input type="text" name="merek" class="form-control" placeholder="Merek" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $data["merek"]; ?>">
						</div>

						<label for="basic-url">Nama Alat</label>
						<div class="input-group mb-3">
						   <input type="text"  name="nama_alat" class="form-control" placeholder="Nama Alat" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $data["nama_alat"]; ?>">
						</div>
						...
						<div class="input-group mb-3">
						   <input type="text" name="jml" class="form-control" placeholder="Jumlah" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $data["jumlah"]; ?>">
						</div>
						<br>
						<div class="input-group mb-3">
